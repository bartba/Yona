...
- **Samsung Gauss 영향 (gpt-5-mini)**: 한국어 TTFT 5-8s + STT ~1s = 체감 총 지연 약 7-9s → 필러 표현 선삽입 검토 필요
- **claude-haiku-4-5 추가 테스트** (한국어 6 프롬프트):
  ...
  - **Samsung Gauss 한국어 환경 최적 모델**: TTFT 0.8s + STT 1s = 체감 지연 약 2s → 음성 어시스턴트 기준 합격
